...
if __name__ == '__main__':
  ...
  changeable_alarms = [alarm for alarm in get_metric_alarms_by_prefix(client, prefix) if current in alarm['AlarmName'].split('-') ]
  ...
  confirmation = input(f"Rename above ({len(changeable_alarms)}) alarms? (y/n): ").lower()
